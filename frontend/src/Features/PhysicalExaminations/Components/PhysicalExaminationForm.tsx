...
import { CreatePhysicalExaminationPayload } from "../Types/physicalExaminations.type";
import { PhysicalExaminationFormLayout } from "../Utils/PhysicalExaminationFormLayout";
import { Select } from "../../../Shared/Components/Select";
import Input from "../../../Shared/Components/Input";

type Props = {
  data: CreatePhysicalExaminationPayload;
...
export function PhysicalExaminationForm({
  ...
  prev,
    ...
    const fields = PhysicalExaminationFormLayout;
