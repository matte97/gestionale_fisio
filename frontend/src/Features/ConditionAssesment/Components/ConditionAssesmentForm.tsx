...
import { conditionAssesmentsFormLayout } from "../Utils/conditionAssessmentFormLayout";

type Props = {
  data: CreateConditionAssesmentPayload;
...
export function ConditionAssesmentForm({
  data,
  onChange,
  onSubmit,
  isLoading,
  ...
  const fields = conditionAssesmentsFormLayout;
  return (
