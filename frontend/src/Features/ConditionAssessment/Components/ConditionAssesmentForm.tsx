...
import { ConditionAssessmentsFormLayout } from "../Utils/conditionAssessmentFormLayout";

type Props = {
  data: CreateConditionAssessmentPayload;
...
export function ConditionAssessmentForm({
  ...
  const fields = ConditionAssessmentsFormLayout;
  return (
